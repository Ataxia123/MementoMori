...
export const Footer = () => {
  return (
    <div className="fixed flex w-full h-1/4 z-10 p-4 bottom-1/3 left-0 pointer-events-none">
      ...
      <div className="fixed items-left justify-left w-full h-5 left-0 bottom-0  pointer-events-auto text-center font-mono font-bold backdrop-blur-lg text-black">
        {" "}
